...
public class changeDetailsByAdmin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(flag){
			// call dashboard
			response.sendRedirect("changesMadeSuccessAdmin.jsp");
		}
		else{
			// call login page
			response.sendRedirect("changesMadeFailureAdmin.jsp");
