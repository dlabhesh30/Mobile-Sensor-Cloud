...
<%
  ...
  String sql = "select sensorname, sum(cost) as a from billing group by sensorname";
  String sql1 = "SELECT hubname, count(*) as a FROM sensortable GROUP BY hubname";
   String sql2 = "select sensorid, State from sensortable";
...
<header class="main-header">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h2> Welcome Admin </h2>
      <ol class="breadcrumb">
        <li><a href="adminDashboard.jsp"><i class="fa fa-dashboard"></i> Home</a></li>
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="allusers.jsp" class="small-box-footer"> <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3>View Sensors</h3>
              <p>View all the deployed sensors </p>
            </div>
            <div class="icon">
              
            </div>
            <a href="viewAllSensorsByAdmin.jsp" class="small-box-footer"> <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3>View Hubs</h3>
              <p>View all deployed hubs</p>
            </div>
            <div class="icon">
              
            </div>
            <a href="viewallhubs.jsp" class="small-box-footer"> <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
	...
	<div class="row">
		...
		<div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="manageusers.jsp" class="small-box-footer"> <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3>Edit Sensors</h3>
              <p>Manage all deployed sensors</p>
            </div>
            <div class="icon">
              
            </div>
            <a href="managesensors.jsp" class="small-box-footer"> <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3>Manage Hubs</h3> 
              <p>Manage all deployed hubs </p>             
            </div>
            <div class="icon">              
            </div>            
            <a href="managehubs.jsp" class="small-box-footer"> <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
