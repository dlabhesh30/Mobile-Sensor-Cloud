  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"> Manage Hubs</li>
      </ol>
    </section>
...
%>			
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">View all hubs</h3>
...
<%		
			while (rs.next()) {
            	...
            	String link = "viewsensorsbyhub.jsp?hubname="+hubname;
%>  			<tbody>
                  <tr>
...
<%			
		...
		e.printStackTrace();
		System.out.println("Exception at printing hubs");
	}
%>
...
<br><br><hr>
               ...
               <h2 align="center" class="box-title">Manage All Hubs</h2>
               <div class="box box-info">
            <div class="box-header with-border">
		...
		<br>
            ...
            <!-- /.box-header -->
            <!-- form start -->
             <h3 align="center"> Choose an action from below and write a hub name to manage existing hubs<br></h3>
             
            <form class="form-horizontal" action="manageHub">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Sensor Name</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3" name="hub" placeholder="Enter Sensor Name">
                  </div>
                </div>
                <div class="form-group">					              
