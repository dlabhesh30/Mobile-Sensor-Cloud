...
Connection con = null;
	...
	try{  
		...
		String query = "SELECT sensorid,totalRequests AS requests FROM sensortable WHERE username='"+username+"' AND hubname='"+location+"' AND State='Running'"+
						"AND totalRequests=(SELECT min(totalRequests) from sensortable WHERE username='"+username+"' AND hubname='"+location+"' AND State='Running' LIMIT 1)";
	...
	<div class="box box-info">
		<div class="box-header with-border">
              <h3 class="box-title">Request is assigned to <%=sensorname %></h3>
