...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="userdashboard.jsp" class="logo">
      ...
      <span class="logo-lg"><b>Highway</b>patroller</span>
    </a>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        View Sensors for the Hub: <%= request.getParameter("hubname") %>
...
Connection con = null;
	...
	try{  
		...
		String hubname =(String)request.getParameter("hubname");
		System.out.println("hubname is "+hubname);
		st=con.createStatement();
		String query = "select * from sensortable where hubname='"+hubname+"'";
		ResultSet rs = st.executeQuery(query);
		if (!rs.isBeforeFirst()) {
			%>
			<br>
			This hub does not have any sensors currently.
			<%
		}
		else{
...
<%		
			while (rs.next()) {
            	...
            	String hubname2 = rs.getString("hubname");
