...
<head>
  ...
  <title>Sendor Creation Failed</title>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="userdashboard.jsp"><i class="fa fa-circle-o"></i> Admin Dashboard</a></li>            
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <br>Sensor creation failed due to no response from AWS. Please try after some time.
      <ol class="breadcrumb">
