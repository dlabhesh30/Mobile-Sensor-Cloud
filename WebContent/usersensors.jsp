...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        All sensors for user: <%= request.getParameter("username") %>
...
%>			
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">View your sensors</h3>
...
<script>
   ...
   st = con.createStatement();
   String sql3 = "select sensorid, source from sensortable where username = '"+request.getParameter("username")+"'";
