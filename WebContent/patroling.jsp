...
%>
            ...
            <!-- /.box-header -->
            <!-- form start -->
             <h3 align="center"> To start patrolling, enter location you want to monitor<br></h3>
            ...
            <form class="form-horizontal" action="assignrequest.jsp">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <h3 align="center"> To stop patrolling, enter location you want to stop monitoring<br></h3>              
              </div>
            </form>
            <form class="form-horizontal" action="stoppatrolrequest.jsp">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Enter hub name</label>
                  ...
                  <div class="col-sm-10">
                    ...
                    <br>
                    <div >                            
                            <button type="submit" class="btn btn-info pull-right" name="Start">Stop</button>                                                                        
                    </div>
                  </div>
                </div>               
              </div>
