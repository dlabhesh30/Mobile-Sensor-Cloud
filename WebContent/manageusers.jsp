...
boolean flag=false;
	try{  
		...
		if (!rs.isBeforeFirst()) {
			%>
			<br>
			You do not have any users currently.
			<%
		}
		else{
...
%>			
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">All Registered Users Currently:</h3>
...
<%		
			while (rs.next()) {
            	...
            	String pin = rs.getString("securityNumber");
            	String date = rs.getString("expiryDate");
            	String name = rs.getString("nameOnCard");
            	String sensorLink = "usersensors.jsp?username="+uname;
%>  			<tbody>
                  <tr>
                    <td><%= fname %></td>
					<td><%= lname %></td>
					...
					<td><%= date %></td>
					<td><%= name %></td>     
					<td><form><a href="<%= sensorLink %>" >Click here</a></form></td>                       
                  </tr>                                   
...
<br><br><hr>
               <h2 align="center" class="box-title">Manage your users</h2>
               <div class="box box-info">
            <div class="box-header with-border">
 ...
 <%
	...
	if(flag){
		...
		<br>
            ...
            <!-- /.box-header -->
            <!-- form start -->
             <h3 align="center"> To edit details of a user, enter Username and Press Go<br></h3>
             
            <form class="form-horizontal" action="editUserAdmin.jsp">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">User Name</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3" name="user" placeholder="Enter User Name">
                  </div>
                </div>
                <div class="form-group">					              
...
%>
            ...
            <!-- /.box-header -->
            <!-- form start -->
             <h3 align="center"> Click Create new to create a new user <br></h3>
            ...
            <form class="form-horizontal" action="signup.jsp">
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-info pull-right" name="createnew">Create New User</button>
              </div>
              <!-- /.box-footer -->
            </form>
                        </div>                    
